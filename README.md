...
```text
dist/超苦逼冒险者-v0.34-html5-flat.zip
```
...
然后打开 `http://127.0.0.1:8123/`。页面应显示 `超苦逼冒险者v0.34`，并且 `index.html` 只能引用 flat 根目录文件，不能引用 `./src/`、`./build/` 或 `./res/`。
...
- [药剂属性表](docs/药剂属性表.md)
- [已知问题](docs/已知问题.md)
- [移动竖屏改动规格](docs/移动竖屏改动规格.md)
- [v0.34 更新内容](docs/v0.34更新内容.md)
- [v0.35 更新内容](docs/v0.35更新内容.md)
...
- 删除废弃的 `flour` 烹饪配方。
- 调整酒精、降温药剂交易价值，新增升温药剂。
- 降温药剂增加水分恢复。
- 区分狙击枪和精锐狙击枪描述。
- 死灵法杖尸体加伤最多按 1000 个尸体计算。
- 新增 v0.34 flat 发布目录和上传 ZIP。
